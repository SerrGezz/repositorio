...
public class UAdminController {
	...
	@PutMapping("/update")
	@ResponseStatus(HttpStatus.CREATED)
	public UAdmin update(@RequestBody UAdmin uAdmin) {
		return uAdminService.update(uAdmin);
	}
	
	@DeleteMapping("/{idUAdmin}")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	public boolean delete(@PathVariable("idUAdmin") int uAdminId) {
		return uAdminService.delete(uAdminId);
	}
}
